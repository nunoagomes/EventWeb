...
public class Event implements Serializable {
    ...
    @JoinColumns({
        @JoinColumn(name = "EventCategoryID", referencedColumnName = "ID", nullable = false)})
    ...
    @org.hibernate.annotations.Cascade({org.hibernate.annotations.CascadeType.LOCK})
    @JoinColumns({
        @JoinColumn(name = "OrganizationUserUserID", referencedColumnName = "UserID", nullable = false)})
    ...
    @JoinTable(name = "RegularUser_Event", joinColumns = {
        @JoinColumn(name = "EventID")}, inverseJoinColumns = {
        @JoinColumn(name = "RegularUserUserID")})
    ...
    public String toString() {
        return "Event[" + "title=" + title + ", date=" + date + ", description=" + description + ", additionalInformation=" + additionalInformation + ", country=" + country + ", city=" + city + ", zip=" + zip + ", address=" + address + ", addressOptional=" + addressOptional + ", price=" + price + ", latitude=" + latitude + ", longitude=" + longitude + ", createTimestamp=" + createTimestamp + ", updateTimestamp=" + updateTimestamp + ']';
    }
